...
class ArgParser:
    def __init__(self, dataset):
        ...
        self.default_values = {
            ...
            'blender':{'custom':False, 'DTU':False, 'TNT':False, 'MobileBrick':False, 'MipNerf360':False}
        }
        ...
        self.parser.add_argument('--blender', action='store_true', help='Set flag if using custom Blender data')
